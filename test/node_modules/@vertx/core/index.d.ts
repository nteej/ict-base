...
export abstract class AsyncFile implements ReadStream<Buffer>, WriteStream<Buffer> {
  ...
  /* override */ handler(handler: ((res: Buffer) => void) | Handler<Buffer> | null | undefined) : AsyncFile;

  /* override */ pause() : AsyncFile;

  /* override */ resume() : AsyncFile;

  /* override */ endHandler(endHandler: ((res: void) => void) | Handler<void> | null | undefined) : AsyncFile;

  /* override */ setWriteQueueMaxSize(maxSize: number) : AsyncFile;

  /* override */ drainHandler(handler: ((res: void) => void) | Handler<void> | null | undefined) : AsyncFile;

  /* override */ exceptionHandler(handler: ((res: Throwable) => void) | Handler<Throwable> | null | undefined) : AsyncFile;

  /* override */ fetch(amount: number) : AsyncFile;
  ...
  /**
   * Like {@link AsyncFile#size} but the <code>handler</code> will be called when the operation is complete or if an error occurs.
   */
   ...
   * Like {@link AsyncFile#size} but the <code>handler</code> will be called when the operation is complete or if an error occurs.
   */
  size(handler: ((res: AsyncResult<number>) => void) | Handler<AsyncResult<number>>) : void;

  /**
   * Try to acquire a non-shared lock on the entire file.
   */
  tryLock() : AsyncFileLock | null;

  /**
   * Try to acquire a lock on a portion of this file.
   */
  tryLock(position: number, size: number, shared: boolean) : AsyncFileLock | null;

  /**
   * Like {@link AsyncFile#lock} but the <code>handler</code> will be called when the operation is complete or if an error occurs.
   */
  lock() : PromiseLike<AsyncFileLock>;

  /**
   * Like {@link AsyncFile#lock} but the <code>handler</code> will be called when the operation is complete or if an error occurs.
   */
  lock(handler: ((res: AsyncResult<AsyncFileLock>) => void) | Handler<AsyncResult<AsyncFileLock>>) : void;

  /**
   * Like {@link AsyncFile#lock} but the <code>handler</code> will be called when the operation is complete or if an error occurs.
   */
  lock(position: number, size: number, shared: boolean) : PromiseLike<AsyncFileLock>;

  /**
   * Like {@link AsyncFile#lock} but the <code>handler</code> will be called when the operation is complete or if an error occurs.
   */
  lock(position: number, size: number, shared: boolean, handler: ((res: AsyncResult<AsyncFileLock>) => void) | Handler<AsyncResult<AsyncFileLock>>) : void;
}

/**
 * A lock on a region of an {@link AsyncFile}.
 */
export abstract class AsyncFileLock {
  /**
   */
  position() : number;
  ...
  /**
   * Like {@link AsyncFileLock#isValid} but the <code>handler</code> will be called when the operation completes or if an error occurs.
   */
   ...
   * Like {@link AsyncFileLock#isValid} but the <code>handler</code> will be called when the operation completes or if an error occurs.
   */
  isValid(handler: ((res: AsyncResult<boolean>) => void) | Handler<AsyncResult<boolean>>) : void;
  ...
  /**
   * Like {@link AsyncFileLock#release} but the <code>handler</code> will be called when the operation completes or if an error occurs.
   */
   ...
   * Like {@link AsyncFileLock#release} but the <code>handler</code> will be called when the operation completes or if an error occurs.
   */
  release(handler: ((res: AsyncResult<void>) => void) | Handler<AsyncResult<void>>) : void;
}
...
export abstract class AsyncMap<K, V> {
   ...
   * In this case, the invocation will result in an OutOfMemoryError.
   */
  keys(resultHandler: ((res: AsyncResult<K>) => void) | Handler<AsyncResult<K>>) : void;
   ...
   * In this case, the invocation will result in an OutOfMemoryError.
   */
  values(resultHandler: ((res: AsyncResult<V>) => void) | Handler<AsyncResult<V>>) : void;
}
...
export abstract class DatagramSocket implements Measured, ReadStream<DatagramPacket> {
  ...
  /**
   */
  /* override */ pause() : DatagramSocket;

  /**
   */
  /* override */ resume() : DatagramSocket;

  /**
   */
  /* override */ fetch(amount: number) : DatagramSocket;

  /**
   */
  /* override */ endHandler(endHandler: ((res: void) => void) | Handler<void> | null | undefined) : DatagramSocket;

  /* override */ handler(handler: ((res: DatagramPacket) => void) | Handler<DatagramPacket> | null | undefined) : DatagramSocket;

  /* override */ exceptionHandler(handler: ((res: Throwable) => void) | Handler<Throwable> | null | undefined) : DatagramSocket;
}
...
import { SSLOptions } from './options';
...
export abstract class HttpClient implements Measured {
  ...
  /**
   * Like {@link HttpClient#updateSSLOptions}  but supplying a handler that will be called when the update
   * happened (or has failed).
   */
  updateSSLOptions(options: SSLOptions) : PromiseLike<void>;

  /**
   * Like {@link HttpClient#updateSSLOptions}  but supplying a handler that will be called when the update
   * happened (or has failed).
   */
  updateSSLOptions(options: SSLOptions, handler: ((res: AsyncResult<void>) => void) | Handler<AsyncResult<void>>) : void;
...
export abstract class HttpClientRequest implements WriteStream<Buffer> {
  ...
  /* override */ exceptionHandler(handler: ((res: Throwable) => void) | Handler<Throwable> | null | undefined) : HttpClientRequest;

  /* override */ setWriteQueueMaxSize(maxSize: number) : HttpClientRequest;

  /* override */ drainHandler(handler: ((res: void) => void) | Handler<void> | null | undefined) : HttpClientRequest;
   ...
   * has been set using this method, then the <code>handler</code> will be called.
   */
  earlyHintsHandler(handler: ((res: MultiMap) => void) | Handler<MultiMap> | null | undefined) : HttpClientRequest;
   ...
   *
   * <p> Use {@link HttpClientResponse#netSocket} to get a  for interacting
   ...
   * Same as {@link HttpClientRequest#end} but with an <code>handler</code> called when the operation completes
   */
  /* override */ end(chunk: Buffer) : PromiseLike<void>;

  /**
   * Same as {@link HttpClientRequest#end} but with an <code>handler</code> called when the operation completes
   */
  /* override */ end(chunk: Buffer, handler: ((res: AsyncResult<void>) => void) | Handler<AsyncResult<void>>) : void;

  /**
   * Same as {@link HttpClientRequest#end} but with an <code>handler</code> called when the operation completes
   */
  /* override */ end() : PromiseLike<void>;

  /**
   * Same as {@link HttpClientRequest#end} but with an <code>handler</code> called when the operation completes
   */
  /* override */ end(handler: ((res: AsyncResult<void>) => void) | Handler<AsyncResult<void>>) : void;
...
export abstract class HttpClientResponse implements ReadStream<Buffer> {
  ...
  /* override */ fetch(amount: number) : HttpClientResponse;

  /* override */ resume() : HttpClientResponse;

  /* override */ exceptionHandler(handler: ((res: Throwable) => void) | Handler<Throwable> | null | undefined) : HttpClientResponse;

  /* override */ handler(handler: ((res: Buffer) => void) | Handler<Buffer> | null | undefined) : HttpClientResponse;

  /* override */ pause() : HttpClientResponse;

  /* override */ endHandler(endHandler: ((res: void) => void) | Handler<void> | null | undefined) : HttpClientResponse;
...
export abstract class HttpConnection {
  ...
  /**
   * Like {@link HttpConnection#remoteAddress} but returns the proxy remote address when <code>real</code> is <code>true</code>
   */
  remoteAddress(real: boolean) : SocketAddress;
  ...
  /**
   * Like {@link HttpConnection#localAddress} ()} but returns the server local address when <code>real</code> is <code>true</code>
   */
  localAddress(real: boolean) : SocketAddress;
...
export abstract class HttpHeaders {
   ...
   */
  static readonly ACCESS_CONTROL_ALLOW_PRIVATE_NETWORK : string;
   ...
   */
  static readonly ACCESS_CONTROL_REQUEST_PRIVATE_NETWORK : string;
   ...
   */
  static readonly DEFLATE_GZIP_BR : string;
...
export abstract class HttpServer implements Measured {
   ...
   *
   * <p> When no specific handler is set, the DEFAULT_INVALID_REQUEST_HANDLER is used.
   */
  invalidRequestHandler(handler: ((res: HttpServerRequest) => void) | Handler<HttpServerRequest>) : HttpServer;
  ...
  /**
   * Like {@link HttpServer#updateSSLOptions}  but supplying a handler that will be called when the update
   * happened (or has failed).
   */
  updateSSLOptions(options: SSLOptions) : PromiseLike<void>;
...
export abstract class HttpServerFileUpload implements ReadStream<Buffer> {
  ...
  /* override */ exceptionHandler(handler: ((res: Throwable) => void) | Handler<Throwable> | null | undefined) : HttpServerFileUpload;

  /* override */ handler(handler: ((res: Buffer) => void) | Handler<Buffer> | null | undefined) : HttpServerFileUpload;

  /* override */ endHandler(endHandler: ((res: void) => void) | Handler<void> | null | undefined) : HttpServerFileUpload;

  /* override */ pause() : HttpServerFileUpload;

  /* override */ resume() : HttpServerFileUpload;

  /* override */ fetch(amount: number) : HttpServerFileUpload;
...
export abstract class HttpServerRequest implements ReadStream<Buffer> {
  ...
  /* override */ exceptionHandler(handler: ((res: Throwable) => void) | Handler<Throwable> | null | undefined) : HttpServerRequest;

  /* override */ handler(handler: ((res: Buffer) => void) | Handler<Buffer> | null | undefined) : HttpServerRequest;

  /* override */ pause() : HttpServerRequest;

  /* override */ resume() : HttpServerRequest;

  /* override */ fetch(amount: number) : HttpServerRequest;

  /* override */ endHandler(endHandler: ((res: void) => void) | Handler<void> | null | undefined) : HttpServerRequest;
  ...
  /**
   * Override the charset to use for decoding the query parameter map, when none is set, <code>UTF8</code> is used.
   */
  setParamsCharset(charset: string) : HttpServerRequest;
  ...
  /**
   * Return the first param value with the specified name or <code>defaultValue</code> when the query param is not present
   */
   ...
   * see: {@link HttpServerRequest#cookies}
   */
  getCookie(name: string) : Cookie | null;

  /**
   * Get the cookie with the specified <code><name, domain, path></code>.
   */
   ...
   * same name but have different keys. A cookie is unique by its <code><name, domain, path></code> tuple.
   *
  ...
  /**
   * Returns a modifiable set of parsed cookies from the <code>COOKIE</code> header. Several cookies may share the
   * same name but have different keys. A cookie is unique by its <code><name, domain, path></code> tuple.
   *
...
export abstract class HttpServerResponse implements WriteStream<Buffer> {
  ...
  /* override */ exceptionHandler(handler: ((res: Throwable) => void) | Handler<Throwable> | null | undefined) : HttpServerResponse;

  /* override */ setWriteQueueMaxSize(maxSize: number) : HttpServerResponse;

  /* override */ drainHandler(handler: ((res: void) => void) | Handler<void> | null | undefined) : HttpServerResponse;
  ...
  /**
   * Same as {@link HttpServerResponse#writeEarlyHints} but with an <code>handler</code> called when the operation completes
   */
  writeEarlyHints(headers: MultiMap) : PromiseLike<void>;

  /**
   * Same as {@link HttpServerResponse#writeEarlyHints} but with an <code>handler</code> called when the operation completes
   */
  writeEarlyHints(headers: MultiMap, handler: ((res: AsyncResult<void>) => void) | Handler<AsyncResult<void>>) : void;
   ...
   * {@link HttpServerResponse#removeCookies}
   */
...
export abstract class JsonParser implements Handler<Buffer>, ReadStream<JsonEvent> {
  ...
  /* override */ pause() : JsonParser;

  /* override */ resume() : JsonParser;

  /* override */ fetch(amount: number) : JsonParser;
...
export abstract class LocalMap<K, V> {
   ...
   * key.
   */
  /* override */ containsKey(key: any) : boolean;

  /**
   * Returns @{code true} if this map maps one or more keys to the
   * specified value.
   */
  /* override */ containsValue(value: any) : boolean;

  /**
   * Returns the value to which the specified key is mapped, or
   * <code>defaultValue</code> if this map contains no mapping for the key.
   */
  /* override */ getOrDefault(key: any, defaultValue: V) : V;
}
...
export abstract class MessageConsumer<T> implements ReadStream<Message<T>> {
  ...
  /* override */ exceptionHandler(handler: ((res: Throwable) => void) | Handler<Throwable> | null | undefined) : MessageConsumer<T>;

  /* override */ handler(handler: ((res: Message<T>) => void) | Handler<Message<T>> | null | undefined) : MessageConsumer<T>;

  /* override */ pause() : MessageConsumer<T>;

  /* override */ resume() : MessageConsumer<T>;

  /* override */ fetch(amount: number) : MessageConsumer<T>;

  /* override */ endHandler(endHandler: ((res: void) => void) | Handler<void> | null | undefined) : MessageConsumer<T>;
...
export abstract class MultiMap {
   ...
   */
  forEach(action: any /* java.util.function.BiConsumer<java.lang.String,java.lang.String> */) : void;
...
export abstract class NetClient implements Measured {
  ...
  /**
   * Like {@link NetClient#updateSSLOptions}  but supplying a handler that will be called when the update
   * happened (or has failed).
   */
  updateSSLOptions(options: SSLOptions) : PromiseLike<void>;
...
export abstract class NetServer implements Measured {
  ...
  /**
   * Like {@link NetServer#updateSSLOptions}  but supplying a handler that will be called when the update
   * happened (or has failed).
   */
  updateSSLOptions(options: SSLOptions) : PromiseLike<void>;
...
export abstract class NetSocket implements ReadStream<Buffer>, WriteStream<Buffer> {
  ...
  /* override */ exceptionHandler(handler: ((res: Throwable) => void) | Handler<Throwable> | null | undefined) : NetSocket;

  /* override */ handler(handler: ((res: Buffer) => void) | Handler<Buffer> | null | undefined) : NetSocket;

  /* override */ pause() : NetSocket;

  /* override */ resume() : NetSocket;

  /* override */ fetch(amount: number) : NetSocket;
   ...
   * buffers to deliver.
   */
  /* override */ endHandler(endHandler: ((res: void) => void) | Handler<void> | null | undefined) : NetSocket;

  /* override */ setWriteQueueMaxSize(maxSize: number) : NetSocket;

  /* override */ drainHandler(handler: ((res: void) => void) | Handler<void> | null | undefined) : NetSocket;
   ...
   * <p>
   * By default, no handler is registered, the feature must be enabled via <a href="../../dataobjects.html#NetClientOptions">NetClientOptions</a> or <a href="../../dataobjects.html#NetServerOptions">NetServerOptions</a>.
   * <p>
  ...
  /**
   * Like {@link NetSocket#remoteAddress} but returns the proxy remote address when <code>real</code> is <code>true</code>
   */
  remoteAddress(real: boolean) : SocketAddress;
  ...
  /**
   * Like {@link NetSocket#localAddress} ()} but returns the server local address when <code>real</code> is <code>true</code>
   */
  localAddress(real: boolean) : SocketAddress;
...
export abstract class RecordParser implements Handler<Buffer>, ReadStream<Buffer> {
  ...
  /* override */ exceptionHandler(handler: ((res: Throwable) => void) | Handler<Throwable> | null | undefined) : RecordParser;

  /* override */ handler(handler: ((res: Buffer) => void) | Handler<Buffer> | null | undefined) : RecordParser;

  /* override */ pause() : RecordParser;

  /* override */ fetch(amount: number) : RecordParser;

  /* override */ resume() : RecordParser;

  /* override */ endHandler(endHandler: ((res: void) => void) | Handler<void> | null | undefined) : RecordParser;
}
...
export abstract class ServerWebSocket implements WebSocketBase {
   ...
   * <p>
   * By default, no handler is registered, the feature must be enabled via <a href="../../dataobjects.html#WebSocketConnectOptions">WebSocketConnectOptions</a> or <a href="../../dataobjects.html#HttpServerOptions">HttpServerOptions</a>.
   * <p>
  ...
  /* override */ exceptionHandler(handler: ((res: Throwable) => void) | Handler<Throwable> | null | undefined) : ServerWebSocket;

  /* override */ handler(handler: ((res: Buffer) => void) | Handler<Buffer> | null | undefined) : ServerWebSocket;

  /* override */ pause() : ServerWebSocket;

  /* override */ resume() : ServerWebSocket;

  /* override */ fetch(amount: number) : ServerWebSocket;

  /* override */ endHandler(endHandler: ((res: void) => void) | Handler<void> | null | undefined) : ServerWebSocket;

  /* override */ setWriteQueueMaxSize(maxSize: number) : ServerWebSocket;

  /* override */ drainHandler(handler: ((res: void) => void) | Handler<void> | null | undefined) : ServerWebSocket;

  /* override */ writeFrame(frame: WebSocketFrame) : PromiseLike<void>;

  /* override */ writeFrame(frame: WebSocketFrame, handler: ((res: AsyncResult<void>) => void) | Handler<AsyncResult<void>>) : ServerWebSocket;

  /* override */ writeFinalTextFrame(text: string) : PromiseLike<void>;

  /* override */ writeFinalTextFrame(text: string, handler: ((res: AsyncResult<void>) => void) | Handler<AsyncResult<void>>) : ServerWebSocket;

  /* override */ writeFinalBinaryFrame(data: Buffer) : PromiseLike<void>;

  /* override */ writeFinalBinaryFrame(data: Buffer, handler: ((res: AsyncResult<void>) => void) | Handler<AsyncResult<void>>) : ServerWebSocket;

  /* override */ writeBinaryMessage(data: Buffer) : PromiseLike<void>;

  /* override */ writeBinaryMessage(data: Buffer, handler: ((res: AsyncResult<void>) => void) | Handler<AsyncResult<void>>) : ServerWebSocket;

  /* override */ writeTextMessage(text: string) : PromiseLike<void>;

  /* override */ writeTextMessage(text: string, handler: ((res: AsyncResult<void>) => void) | Handler<AsyncResult<void>>) : ServerWebSocket;

  /* override */ closeHandler(handler: ((res: void) => void) | Handler<void> | null | undefined) : ServerWebSocket;

  /* override */ frameHandler(handler: ((res: WebSocketFrame) => void) | Handler<WebSocketFrame> | null | undefined) : ServerWebSocket;
...
export abstract class SocketAddress {
  /**
   * Create an inet socket address that binds to a shared random port identified by <code>id</code>.
   * <br/>
   * The <code>host</code> string can be a host name or a host address.
   * <br/>
   * No name resolution will be attempted.
   */
  static sharedRandomPort(id: number, host: string) : SocketAddress;

  /**
   * Create an inet socket address, <code>host</code> must be non <code>null</code> and <code>port</code> must be between <code>0</code>
   * and <code>65536</code>.
   * <br/>
   * The <code>host</code> string can be a host name or a host address.
   * <br/>
...
export abstract class TimeoutStream implements ReadStream<number> {
  ...
  /* override */ exceptionHandler(handler: ((res: Throwable) => void) | Handler<Throwable> | null | undefined) : TimeoutStream;

  /* override */ handler(handler: ((res: number) => void) | Handler<number> | null | undefined) : TimeoutStream;

  /* override */ pause() : TimeoutStream;

  /* override */ resume() : TimeoutStream;

  /* override */ fetch(amount: number) : TimeoutStream;

  /* override */ endHandler(endHandler: ((res: void) => void) | Handler<void> | null | undefined) : TimeoutStream;
...
export abstract class Vertx implements Measured {
  ...
  /**
   * Set a periodic timer to fire every <code>delay</code> milliseconds with initial delay, at which point <code>handler</code> will be called with
   * the id of the timer.
   */
   ...
   * the  has been called.
   */
  periodicStream(initialDelay: number, delay: number) : TimeoutStream;
  ...
  /**
   * Like {@link Vertx#createSharedWorkerExecutor} but with the <a href="../../dataobjects.html#VertxOptions">VertxOptions</a> <code>maxExecuteTimeUnit</code>.
   */
...
export abstract class WebSocket implements WebSocketBase {
  ...
  /* override */ exceptionHandler(handler: ((res: Throwable) => void) | Handler<Throwable> | null | undefined) : WebSocket;

  /* override */ handler(handler: ((res: Buffer) => void) | Handler<Buffer> | null | undefined) : WebSocket;

  /* override */ pause() : WebSocket;

  /* override */ resume() : WebSocket;

  /* override */ fetch(amount: number) : WebSocket;

  /* override */ endHandler(endHandler: ((res: void) => void) | Handler<void> | null | undefined) : WebSocket;

  /* override */ setWriteQueueMaxSize(maxSize: number) : WebSocket;

  /* override */ drainHandler(handler: ((res: void) => void) | Handler<void> | null | undefined) : WebSocket;

  /* override */ writeFrame(frame: WebSocketFrame) : PromiseLike<void>;

  /* override */ writeFrame(frame: WebSocketFrame, handler: ((res: AsyncResult<void>) => void) | Handler<AsyncResult<void>>) : WebSocket;

  /* override */ writeFinalTextFrame(text: string) : PromiseLike<void>;

  /* override */ writeFinalTextFrame(text: string, handler: ((res: AsyncResult<void>) => void) | Handler<AsyncResult<void>>) : WebSocket;

  /* override */ writeFinalBinaryFrame(data: Buffer) : PromiseLike<void>;

  /* override */ writeFinalBinaryFrame(data: Buffer, handler: ((res: AsyncResult<void>) => void) | Handler<AsyncResult<void>>) : WebSocket;

  /* override */ writeBinaryMessage(data: Buffer) : PromiseLike<void>;

  /* override */ writeBinaryMessage(data: Buffer, handler: ((res: AsyncResult<void>) => void) | Handler<AsyncResult<void>>) : WebSocket;

  /* override */ writeTextMessage(text: string) : PromiseLike<void>;

  /* override */ writeTextMessage(text: string, handler: ((res: AsyncResult<void>) => void) | Handler<AsyncResult<void>>) : WebSocket;

  /* override */ closeHandler(handler: ((res: void) => void) | Handler<void> | null | undefined) : WebSocket;

  /* override */ frameHandler(handler: ((res: WebSocketFrame) => void) | Handler<WebSocketFrame> | null | undefined) : WebSocket;
...
export interface WebSocketBase extends ReadStream<Buffer>, WriteStream<Buffer> {
  ...
  /* override */ exceptionHandler(handler: ((res: Throwable) => void) | Handler<Throwable> | null | undefined) : WebSocketBase;

  /* override */ handler(handler: ((res: Buffer) => void) | Handler<Buffer> | null | undefined) : WebSocketBase;

  /* override */ pause() : WebSocketBase;

  /* override */ resume() : WebSocketBase;

  /* override */ fetch(amount: number) : WebSocketBase;

  /* override */ endHandler(endHandler: ((res: void) => void) | Handler<void> | null | undefined) : WebSocketBase;

  /* override */ setWriteQueueMaxSize(maxSize: number) : WebSocketBase;

  /* override */ drainHandler(handler: ((res: void) => void) | Handler<void> | null | undefined) : WebSocketBase;
...
import { WebSocketFrameType } from './enums';
...
export interface WriteStream<T> extends StreamBase {
   ...
   */
  /* override */ exceptionHandler(handler: ((res: Throwable) => void) | Handler<Throwable> | null | undefined) : WriteStream<T>;
